...
class SuppliesControllerTest < ActionController::TestCase
  ...
  test "should create supply" do
    assert_difference('Supply.count') do
      post :create, supply: { category_id: @supply.category_id, description: @supply.description, qty: @supply.qty, unit: @supply.unit, value: @supply.value }
    end
  ...
  test "should update supply" do
    patch :update, id: @supply, supply: { category_id: @supply.category_id, description: @supply.description, qty: @supply.qty, unit: @supply.unit, value: @supply.value }
    assert_redirected_to supply_path(assigns(:supply))
  end
